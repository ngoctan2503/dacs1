...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        initComponents();
        init();
        JPanel FormHome = new JPanel();
        JPanel Testt = new JPanel();
        
        add(FormHome, BorderLayout.NORTH);
        add(Testt, BorderLayout.SOUTH);
    }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
               JFrame loginFrame = new JFrame("Login");
                ...
                loginFrame.setMinimumSize(new Dimension(934, 500));
                loginFrame.setMaximumSize(new Dimension(934, 500));
