...
public class Form7 extends javax.swing.JPanel {
    ...
    private void init() {
       ...
       mainPanel1.add(home);
        ...
        itemListMen.add(new ModelItem(3, "AIR FORCE 1", "NMD City Stock 2", 1, 100, "Adidas", 100, new ImageIcon(getClass().getResource("/com/raven/images/img3.png"))));
        itemListMen.add(new ModelItem(4, "AIR JORDAN 1", "NMD City Stock 2", 1, 600, "Adidas", 600, new ImageIcon(getClass().getResource("/com/raven/images/img4.png"))));
        ...
        itemListMen.add(new ModelItem(7, "LA SPORTIVA", "NMD City Stock 1", 1, 1099, "Adidas", 1099, new ImageIcon(getClass().getResource("/com/raven/images/img7.png"))));
        itemListMen.add(new ModelItem(8, "LA SPORTIVA", "NMD City Stock 2", 1, 1199, "Adidas", 1199, new ImageIcon(getClass().getResource("/com/raven/images/img8.png"))));
        itemListMen.add(new ModelItem(9, "LA SPORTIVA X JANJI JACKAL II", "NMD City Stock 2", 1, 105, "Adidas", 105, new ImageIcon(getClass().getResource("/com/raven/images/img9.png"))));
        itemListMen.add(new ModelItem(10, "JACKAL II BOA", "NMD City Stock 2", 1, 185, "LA SPORTIVA", 185, new ImageIcon(getClass().getResource("/com/raven/images/img10.png"))));
        itemListMen.add(new ModelItem(11, "AKASHA II", "NMD City Stock 2", 1, 275, "LA SPORTIVA", 275, new ImageIcon(getClass().getResource("/com/raven/images/img11.png"))));
        itemListMen.add(new ModelItem(12, "MUTANT", "NMD City Stock 2", 1, 165, "LA SPORTIVA", 165, new ImageIcon(getClass().getResource("/com/raven/images/img12.png"))));
        itemListMen.add(new ModelItem(13, "CYKLON CROSS GTX", "NMD City Stock 2", 1, 245, "LA SPORTIVA", 245, new ImageIcon(getClass().getResource("/com/raven/images/img13.png"))));
        itemListMen.add(new ModelItem(14, "CYKLON", "NMD City Stock 2", 1, 235, "LA SPORTIVA", 235, new ImageIcon(getClass().getResource("/com/raven/images/img14.png"))));
        itemListMen.add(new ModelItem(15, "BLIZZARD GTX", "NMD City Stock 2", 1, 275, "Adidas", 275, new ImageIcon(getClass().getResource("/com/raven/images/img15.png"))));
        ...
        itemListMen.add(new ModelItem(21, "WILDCAT", "NMD City Stock 2", 1, 535, "LA SPORTIVA", 535, new ImageIcon(getClass().getResource("/com/raven/images/img21.png"))));
